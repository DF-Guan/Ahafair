...
<p align="center">
  <a href="https://ahafair.app">🌐 官网</a> •
  <a href="https://edit.ahafair.app">✏️ 在线使用</a> •
  <a href="https://ahafair.app/docs">📖 文档</a> •
  <a href="https://github.com/tenngoxars/Ahafair/releases">📦 下载桌面版</a>
</p>
...
👉 **[查看算法详细原理解析](https://ahafair.app/docs/reference/dark-mode-algorithm.html)** | **[查看算法源码](packages/core/src/wechatDarkMode.ts)**
...
直接访问 **[edit.ahafair.app](https://edit.ahafair.app)** 即可开始写作，无需安装，同样支持纯本地存储。

### 桌面版下载

前往 [Releases](https://github.com/tenngoxars/Ahafair/releases) 下载对应平台安装包：
