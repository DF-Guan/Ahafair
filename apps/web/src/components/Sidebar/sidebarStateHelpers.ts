...
const COLLAPSED_KEY = "ahafair-folder-collapsed";

export const ROOT_DROP_TARGET = "__root__";
export const FILE_DRAG_TYPE = "application/x-ahafair-file";
export const FOLDER_DRAG_TYPE = "application/x-ahafair-folder";
